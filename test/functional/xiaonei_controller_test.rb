require 'test_helper'
OpenSocialGadget::Config.load File.join('vendor/plugins/opensocial_gadget', 'test', 'gadget.yml')

CONSUMER_KEY = '999999999999'
REQUESTOR_ID = '00000000000000000000'
VIEW_TYPE = 'home'

class XiaoneiControllerTest < ActionController::TestCase
  def setup
    @controller = XiaoneiController.new
