AppConfig.default_mce_options = { 
  ...
  :plugins => %w{preview advimage paste inlinepopups safari autosave wikilink},
...
AppConfig.simple_mce_options = {
  ...
  :editor_deselector => "mceNoEditor",
  :theme_advanced_resize_horizontal => false,  
  :theme_advanced_buttons1 => %w{formatselect bold italic underline separator blockquote bullist numlist hr separator link unlink image separator undo redo code},
  :theme_advanced_buttons2 => %w{},
  :theme_advanced_buttons3 => []
  } 
  
AppConfig.wiki_mce_options = { 
  :width => "580",
  :height => "300",
  :language => "zh", 
  :theme => 'advanced',
  ...
  :editor_deselector => "mceNoEditor",
  :theme_advanced_resize_horizontal => false,  
  :theme_advanced_buttons1 => %w{formatselect bold italic underline separator blockquote bullist numlist hr separator wikilink link unlink image separator undo redo code},
  :theme_advanced_buttons2 => %w{},
  :theme_advanced_buttons3 => [],
  :plugins => %w{wikilink},
  :extended_valid_elements => "img[class|src|flashvars|border=0|alt|title|hspace|vspace|width|height|align|onmouseover|onmouseout|name|obj|param|embed|scale|wmode|salign|style],embed[src|quality|scale|salign|wmode|bgcolor|width|height|name|align|type|pluginspage|flashvars],object[align<bottom?left?middle?right?top|archive|border|class|classid|codebase|codetype|data|declare|dir<ltr?rtl|height|hspace|id|lang|name|style|tabindex|title|type|usemap|vspace|width]"
