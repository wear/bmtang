...
module WikiFormatting
  ...
  class << self
    ...
    def formatter_for(name)
      ...
      (entry && entry[:formatter]) || WikiFormatting::NullFormatter::Formatter
    end
    
    def helper_for(name)
      entry = @@formatters[name.to_sym]
      (entry && entry[:helper]) || WikiFormatting::NullFormatter::Helper
    end
...
WikiFormatting.map do |format|
  format.register :textile, WikiFormatting::Textile::Formatter, WikiFormatting::Textile::Helper
end
